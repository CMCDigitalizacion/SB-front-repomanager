...
!function(a) {
    ...
    h.DEFAULTS = {
        ...
        queryParams: function(a) {
            return a
        }, queryParamsType : "limit", responseHandler : function(a) {
            return a
        }, pagination: !1, sidePagination : "client", totalRows : 0, pageNumber : 1, pageSize : 10, pageList : [10, 25, 50, 100], search : !1, searchAlign : "right", selectItemName : "btSelectItem", showHeader : !0, showColumns : !1, showRefresh : !1, showToggle : !1, smartDisplay : !0, minimumCountColumns : 1, idField : void 0, cardView : !1, clickToSelect : !1, singleSelect : !1, toolbar : void 0, toolbarAlign : "right", checkboxHeader : !0, sortable : !0, maintainSelected : !1, rowStyle : function() {
            return {}
        ...
        this.$header = this.$el.find("thead"), this.$header.length || (this.$header = a("<thead></thead>").appendTo(this.$el)), this.$header.find("tr").length || this.$header.append("<tr></tr>"), this.$header.find("th").each(function() {
            ...
            c._id = a(this).attr("id"), c._class = a(this).attr("class"), a(this).find("td").each(function(d) {
                ...
                c[e] = a(this).html(), c["_" + e + "_id"] = a(this).attr("id"), c["_" + e + "_class"] = a(this).attr("class")
            }), d.push(c)
        }), this.options.data = d)
        ...
        this.data = b ? this.data.concat(a) : a || this.options.data, this.options.data = this.data, "server" !== this.options.sidePagination && this.initSort()
        ...
        - 1 !== e && this.data.sort(function(g, h) {
            var i = g[c], j = h[c], k = f(b.header, b.header.sorters[e], [i, j]);
            return void 0 !== k ? d * k : (a.isNumeric(i) && (i = parseFloat(i)), a.isNumeric(j) && (j = parseFloat(j)), (void 0 === i || null === i) && (i = ""), (void 0 === i || null === j) && (j = ""), i === j ? 0 : j > i?-1 * d : d)
        })
        ...
        this.$toolbar = this.$container.find(".fixed-table-toolbar").html(""), "string" == typeof this.options.toolbar && a('<div class="bars pull-left"></div>').appendTo(this.$toolbar).append(a(this.options.toolbar)), f = ['<div class="columns columns-' + this.options.toolbarAlign + " btn-group pull-" + this.options.toolbarAlign + '">'], this.options.showRefresh && f.push(b('<button class="btn btn-default" type="button" name="refresh" title="%s">', this.options.formatRefresh()), '<i class="glyphicon glyphicon-refresh icon-refresh"></i>', "</button>"), this.options.showToggle && f.push(b('<button class="btn btn-default" type="button" name="toggle" title="%s">', this.options.formatToggle()), '<i class="glyphicon glyphicon glyphicon-list-alt icon-list-alt"></i>', "</button>"), this.options.showColumns && (f.push(b('<div class="keep-open btn-group" title="%s">', this.options.formatColumns()), '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">', '<i class="glyphicon glyphicon-th icon-th"></i>', ' <span class="caret"></span>', "</button>", '<ul class="dropdown-menu" role="menu">'), a.each(this.options.columns, function(a, c) {
            if (!c.radio&&!c.checkbox) {
                ...
                c.switchable && (f.push(b('<li><label><input type="checkbox" data-field="%s" value="%s"%s> %s</label></li>', c.field, a, d, c.title)), h++)
            }
        }), f.push("</ul>", "</div>")), f.push("</div>"), f.length > 2 && this.$toolbar.append(f.join("")), this.options.showRefresh && this.$toolbar.find('button[name="refresh"]').off("click").on("click", a.proxy(this.refresh, this)), this.options.showToggle && this.$toolbar.find('button[name="toggle"]').off("click").on("click", function() {
            e.options.cardView=!e.options.cardView, e.initHeader(), e.initBody()
        }), this.options.showColumns && (c = this.$toolbar.find(".keep-open"), h <= this.options.minimumCountColumns && c.find("input").prop("disabled", !0), c.find("li").off("click").on("click", function(a) {
        ...
        })), this.options.search && (f = [], f.push('<div class="pull-' + this.options.searchAlign + ' search">', b('<input class="form-control" type="text" placeholder="%s">', this.options.formatSearch()), "</div>"), this.$toolbar.append(f.join("")), d = this.$toolbar.find(".search input"), d.off("keyup").on("keyup", function(a) {
        ...
        a(b.currentTarget).val(c), c !== this.searchText && (this.searchText = c, this.options.pageNumber = 1, this.initSearch(), this.updatePagination(), this.trigger("search", c))
        ...
        if (this.$pagination = this.$container.find(".fixed-table-pagination"), this.options.pagination) {
            ...
            "server" !== this.options.sidePagination && (this.options.totalRows = n.length), this.totalPages = 0, this.options.totalRows && (this.totalPages=~~((this.options.totalRows - 1) / this.options.pageSize) + 1), this.totalPages > 0 && this.options.pageNumber > this.totalPages && (this.options.pageNumber = this.totalPages), this.pageFrom = (this.options.pageNumber - 1) * this.options.pageSize + 1, this.pageTo = this.options.pageNumber * this.options.pageSize, this.pageTo > this.options.totalRows && (this.pageTo = this.options.totalRows), m.push('<div class="pull-left pagination-detail">', '<span class="pagination-info">', this.options.formatShowingRows(this.pageFrom, this.pageTo, this.options.totalRows), "</span>"), m.push('<span class="page-list">');
            var o = ['<span class="btn-group dropup">', '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">', '<span class="page-size">', this.options.pageSize, "</span>", ' <span class="caret"></span>', "</button>", '<ul class="dropdown-menu" role="menu">'], p = this.options.pageList;
            if ("string" == typeof this.options.pageList) {
                var q = this.options.pageList.slice(1, - 1).replace(/ /g, "").split(",");
                p = [], a.each(q, function(a, b) {
                    p.push( + b)
                })
            }
            for (a.each(p, function(a, c) {
                if (!l.options.smartDisplay || l.options.totalRows >= c || 0 === a) {
                    var d = c === l.options.pageSize ? ' class="active"': "";
                    o.push(b('<li%s><a href="javascript:void(0)">%s</a></li>', d, c))
                }
            }), o.push("</ul></span>"), m.push(this.options.formatRecordsPerPage(o.join(""))), m.push("</span>"), m.push("</div>", '<div class="pull-right pagination">', '<ul class="pagination">', '<li class="page-first"><a href="javascript:void(0)">&lt;&lt;</a></li>', '<li class="page-pre"><a href="javascript:void(0)">&lt;</a></li>'), this.totalPages < 5 ? (d = 1, e = this.totalPages) : (d = this.options.pageNumber - 2, e = d + 4, 1 > d && (d = 1, e = 5), e > this.totalPages && (e = this.totalPages, d = e - 4)), c = d; e >= c; c++)
                m.push('<li class="page-number' + (c === this.options.pageNumber ? " active disabled" : "") + '">', '<a href="javascript:void(0)">', c, "</a>", "</li>");
        ...
        b && a(b.currentTarget).hasClass("disabled") || (this.options.maintainSelected || this.resetRows(), this.initPagination(), "server" === this.options.sidePagination ? this.initServer() : this.initBody(), this.trigger("page-change", this.options.pageSize, this.options.pageNumber))
    ...
    }, h.prototype.initBody = function(d) {
        var e = this, h = [], i = this.getData();
        this.trigger("pre-body", i), this.$body = this.$el.find("tbody"), this.$body.length || (this.$body = a("<tbody></tbody>").appendTo(this.$el)), "server" === this.options.sidePagination && (i = this.data), this.options.pagination && "server" !== this.options.sidePagination || (this.pageFrom = 1, this.pageTo = i.length);
        for (var j = this.pageFrom - 1; j < this.pageTo; j++) {
            var k = i[j], l = {}, m = [], n = {}, o = [];
            if (l = f(this.options, this.options.rowStyle, [k, j], l), l && l.css)
                for (var p in l.css)
                    m.push(p + ": " + l.css[p]);
            if (n = f(this.options, this.options.rowAttributes, [k, j], n))
                for (var p in n)
                    o.push(b('%s="%s"', p, g(n[p])));
            h.push("<tr", b(" %s", o.join(" ")), b(' id="%s"', a.isArray(k) ? void 0 : k._id), b(' class="%s"', l.classes || (a.isArray(k) ? void 0 : k._class)), b(' data-index="%s"', j), ">"), this.options.cardView && h.push(b('<td colspan="%s">', this.header.fields.length)), a.each(this.header.fields, function(a, d) {
                var g = "", i = k[d], n = "", o = {}, p = "", q = e.header.classes[a];
                if (l = b('style="%s"', m.concat(e.header.styles[a]).join("; ")), i = f(e.header, e.header.formatters[a], [i, k, j], i), k["_" + d + "_id"] && (p = b(' id="%s"', k["_" + d + "_id"])), k["_" + d + "_class"] && (q = b(' class="%s"', k["_" + d + "_class"])), o = f(e.header, e.header.cellStyles[a], [i, k, j], o), o.classes && (q = b(' class="%s"', o.classes)), o.css) {
                    m = [];
                    for (var r in o.css)
                        m.push(r + ": " + o.css[r]);
                    l = b('style="%s"', m.concat(e.header.styles[a]).join("; "))
                }
                if (e.options.columns[a].checkbox || e.options.columns[a].radio) {
                    if (e.options.cardView)
                        return !0;
                    n = e.options.columns[a].checkbox ? "checkbox" : n, n = e.options.columns[a].radio ? "radio" : n, g = ['<td class="bs-checkbox">', "<input" + b(' data-index="%s"', j) + b(' name="%s"', e.options.selectItemName) + b(' type="%s"', n) + b(' value="%s"', k[e.options.idField]) + b(' checked="%s"', i===!0 || i && i.checked ? "checked" : void 0) + b(' disabled="%s"', !e.options.columns[a].checkboxEnabled || i && i.disabled ? "disabled" : void 0) + " />", "</td>"].join("")
                } else 
                    i = "undefined" == typeof i || null === i ? e.options.undefinedText : i, g = e.options.cardView ? ['<div class="card-view">', e.options.showHeader ? b('<span class="title" %s>%s</span>', l, c(e.options.columns, "field", "title", d)): "", b('<span class="value">%s</span>', i), "</div>"].join("") : [b("<td%s %s %s>", p, q, l), i, "</td>"].join(""), e.options.cardView && e.options.smartDisplay && "" === i && (g = "");
                h.push(g)
            }), this.options.cardView && h.push("</td>"), h.push("</tr>")
        }
        h.length || h.push('<tr class="no-records-found">', b('<td colspan="%s">%s</td>', this.header.fields.length, this.options.formatNoMatches()), "</tr>"), this.$body.html(h.join("")), d || this.scrollTo(0), this.$body.find("> tr > td").off("click").on("click", function() {
            var c = a(this).parent();
            e.trigger("click-row", e.data[c.data("index")], c), e.options.clickToSelect && e.header.clickToSelects[c.children().index(a(this))] && c.find(b('[name="%s"]', e.options.selectItemName))[0].click()
        }), this.$body.find("tr").off("dblclick").on("dblclick", function() {
            e.trigger("dbl-click-row", e.data[a(this).data("index")], a(this))
        }), this.$selectItem = this.$body.find(b('[name="%s"]', this.options.selectItemName)), this.$selectItem.off("click").on("click", function(b) {
            b.stopImmediatePropagation();
            var c = a(this).prop("checked"), d = e.data[a(this).data("index")];
            d[e.header.stateField] = c, e.trigger(c ? "check" : "uncheck", d), e.options.singleSelect && (e.$selectItem.not(this).each(function() {
                e.data[a(this).data("index")][e.header.stateField]=!1
            }), e.$selectItem.filter(":checked").not(this).prop("checked", !1)), e.updateSelected()
        }), a.each(this.header.events, function(b, c) {
            if (c) {
                "string" == typeof c && (c = f(null, c));
                for (var d in c)
                    e.$body.find("tr").each(function() {
                        var f = a(this), g = f.find(e.options.cardView ? ".card-view" : "td").eq(b), h = d.indexOf(" "), i = d.substring(0, h), j = d.substring(h + 1), k = c[d];
                        g.find(j).off(i).on(i, function(a) {
                            var c = f.data("index"), d = e.data[c], g = d[e.header.fields[b]];
                            k.apply(this, [a, g, d, c])
                        })
                    })
            }
        }), this.updateSelected(), this.resetView(), this.trigger("post-body")
    }, h.prototype.initServer = function(b) {
        var c = this, d = {}, e = {
        ...
        this.options.url && ("limit" === this.options.queryParamsType && (e = {
            limit: e.pageSize,
            offset: e.pageSize * (e.pageNumber - 1),
            search: e.searchText,
            sort: e.sortName,
            order: e.sortOrder
        }), d = f(this.options, this.options.queryParams, [e], d), d!==!1 && (b || this.$loading.show(), a.ajax({
            ...
            success: function(a) {
                a = f(c.options, c.options.responseHandler, [a], a);
                var b = a;
                "server" === c.options.sidePagination && (c.options.totalRows = a.total, b = a.rows), c.load(b), c.trigger("load-success", b)
            },
            error: function(a) {
                c.trigger("load-error", a.status)
            },
            complete: function() {
                b || c.$loading.hide()
            }
        ...
        return this.options.cardView ? (b.$el.css("margin-top", "0"), void b.$container.find(".fixed-table-container").css("padding-bottom", "0")) : (this.options.showHeader && this.options.height && this.resetHeader(), void(this.options.height && this.options.showHeader && this.$container.find(".fixed-table-container").css("padding-bottom", "37px")))
        ...
        this.initData(a), this.initSearch(), this.initPagination(), this.initBody()
    }, h.prototype.append = function(a) {
        this.initData(a, !0), this.initSearch(), this.initPagination(), this.initBody(!0)
    }, h.prototype.remove = function(b) {
        var c, d, e = this.options.data.length;
        if (b.hasOwnProperty("field") && b.hasOwnProperty("values")) {
            for (c = e - 1; c >= 0; c--) {
                if (d = this.options.data[c], !d.hasOwnProperty(b.field))
                    return;
                - 1 !== a.inArray(d[b.field], b.values) && this.options.data.splice(c, 1)
            }
        ...
        this.$selectItem.filter(":enabled").prop("checked", a), this.updateRows(a), this.updateSelected(), this.trigger(a ? "check-all" : "uncheck-all")
    }, h.prototype.check = function(a) {
        this.check_(!0, a)
    }, h.prototype.uncheck = function(a) {
        this.check_(!1, a)
    }, h.prototype.check_ = function(a, c) {
        this.$selectItem.filter(b('[data-index="%s"]', c)).prop("checked", a), this.data[c][this.header.stateField] = a, this.updateSelected()
    }, h.prototype.destroy = function() {
        this.$el.insertBefore(this.$container), a(this.options.toolbar).insertBefore(this.$el), this.$container.next().remove(), this.$container.remove(), this.$el.html(this.$el_.html()).attr("class", this.$el_.attr("class") || "")
    }, h.prototype.showLoading = function() {
        this.$loading.show()
    }, h.prototype.hideLoading = function() {
        this.$loading.hide()
    }, h.prototype.refresh = function(a) {
        a && a.url && (this.options.url = a.url, this.options.pageNumber = 1), this.initServer(a && a.silent)
        ...
        this.options.pageNumber > 1 ? this.options.pageNumber-- : null, this.updatePagination()
    }, h.prototype.nextPage = function() {
        this.options.pageNumber < this.options.pageSize ? this.options.pageNumber++ : null, this.updatePagination()
    };
    var i = ["getSelections", "getData", "load", "append", "remove", "updateRow", "mergeCells", "checkAll", "uncheckAll", "check", "uncheck", "refresh", "resetView", "destroy", "showLoading", "hideLoading", "showColumn", "hideColumn", "filterBy", "scrollTo", "prevPage", "nextPage"];
